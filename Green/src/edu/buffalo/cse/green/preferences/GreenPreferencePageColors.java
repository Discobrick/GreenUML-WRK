	...
	public boolean performOk() {
		...
		for (DiagramEditor editor : DiagramEditor.getEditors()) {
			if (aaa.getBooleanValue() == true) {
                ...
                store.setValue(PreferenceInitializer.P_COLOR_UML, "100,100,100"); 					
                store.setValue(PreferenceInitializer.P_COLOR_SELECTED, "16,152,61"); 				
                store.setValue(PreferenceInitializer.P_COLOR_TYPE_BORDER, "0,0,0"); 				
                store.setValue(PreferenceInitializer.P_COLOR_TYPE_BORDER_HIDDENR, "255,255,255"); 	
                store.setValue(PreferenceInitializer.P_COLOR_COMPARTMENT_BORDER, "0,0,0"); 			
                store.setValue(PreferenceInitializer.P_COLOR_TYPE_TEXT, "255,255,255"); 			
                ...
                store.setValue(PreferenceInitializer.P_COLOR_REL_ARROW_FILL, "255,255,255"); 		
                store.setValue(PreferenceInitializer.P_COLOR_REL_LINE, "0,0,0"); 					
                store.setValue(PreferenceInitializer.P_COLOR_REL_TEXT, "0,0,0"); 					
